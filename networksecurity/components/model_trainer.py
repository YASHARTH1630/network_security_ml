...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            train_file_path=self.data_transformation_arifact.transformed_train_file_path
            test_file_path=self.data_transfomation_artifact.transformed_test_file_path
