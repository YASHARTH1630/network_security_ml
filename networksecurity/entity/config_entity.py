...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config: TrainingPipelineConfig):
        ...
        self.trained_model_file_path:str=os.path.join(
            self.model_trainer_dir,training_pipeline.MODEL_TRAINER_TRAINING_TRAINED_MODEL_DIR,
            training_pipeline.MODEL_TRAINER_TRAINED_MODEL_NAME
        )
        self.excepted_accuracy:float=training_pipeline.MODEL_TRAINER_EXCEPTED_SCORE
        self.overfitting_underfitting_threshold=training_pipeline.MODEL_TRAINER_OVERFITTING_UNDER_FITTING_THRESHOLD